...
const AddLocation = () => {
  ...
  const handleSubmit = () => {
    ...
    //posting the location data
    axios({
      method: "post",

      url: `${process.env.REACT_APP_API}/admin/add_location`,
          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  <OutlinedInput
                    placeholder="Unit/Bulilding"
                    size="small"
                    value={unit_or_building}
                    onChange={(e) => setUnit_or_building(e.target.value)}
                  />
                </TableCell>
              </TableRow>
              <TableRow>
